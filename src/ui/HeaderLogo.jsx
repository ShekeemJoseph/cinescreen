...
const BigScreenLogo = styled.svg`
  display: block;
  ${media.md`
    display: none;
  `}
`;
const SmallScreenLogo = styled.svg`
  display: none;
  ${media.md`
    display: block;
  `}
...
function HeaderLogo({ primaryColor = "#fbc117", secondaryColor = "#fff" }) {
  return (
    <>
      <BigScreenLogo
      ...
      <SmallScreenLogo
        ...
        viewBox="0 0 128 128"
      >
        <g transform="matrix(0.8046875,0,0,0.8046875,12.760752631578946,22.756582386801675)">
          <svg
            viewBox="0 0 95 76"
            data-background-color={primaryColor}
            preserveAspectRatio="xMidYMid meet"
          ...
          >
            <g
              id="tight-bounds"
              transform="matrix(1,0,0,1,-0.24049999999999727,0.18922201991179577)"
            >
              <svg
                viewBox="0 0 95.481 75.62155596017641"
                height="75.62155596017641"
                width="95.481"
              >
                <g>
                  <svg
